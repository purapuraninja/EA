...
//--- Filters (XAU default)
input int                 InpMaxSpreadPoints     = 260;     // spread kamu ~160 pts -> kasih ruang
...
//--- Trailing
input ENUM_TRAIL_MODE     InpTrailMode           = TRAIL_POINTS;
...
input double              InpTP1_ClosePercent    = 50.0;    // close % at TP1

//--- Breakeven
input bool                InpEnableBE            = true;
input int                 InpBE_TriggerPoints    = 360;     // rekomendasi >= 2x spread
input int                 InpBE_OffsetPoints     = 30;      // BE + buffer
